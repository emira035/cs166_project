...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "select S.sname, count(*) from Suppliers S, Catalog C, Parts P where S.sid = C.sid and P.pid = C.pid group by S.sname;";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
   ...
   public static void Query2(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "select S.sname, count(*) from Suppliers S, Catalog C, Parts P where S.sid = C.sid and P.pid = C.pid group by S.sname having count(*) >= 3;";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
   ...
   public static void Query3(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "select S.sname, count(*) from Suppliers S, Catalog C, Parts P where S.sid = C.sid and P.pid = C.pid and P.color = 'Green' group by S.sname;";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
   ...
   public static void Query4(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "select S.sname, count(*), max(C.cost) from Suppliers S, Catalog C, Parts P where S.sid = C.sid and P.pid = C.pid and S.sid in (select S.sid from Suppliers S, Catalog C, Parts P where S.sid = C.sid and P.pid = C.pid and P.color = 'Green' intersect select S.sid from Suppliers S, Catalog C, Parts P where S.sid = C.sid and P.pid = C.pid and P.color = 'Red') group by S.sname;";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
...
/*
Start with Lab5 first since lab6 is a extention of it
1) Put lab 6 into the bolt
2) Use the CP command from lab5
3) CP the text file then run PSQL command
4) Go to lab6 now
5) run the compile.sh from lab6
6) enter 0, then 10
it will output everything: parts that are lower than 10$
input and nothing will return since none is lower than 1
7)
8)
9)
